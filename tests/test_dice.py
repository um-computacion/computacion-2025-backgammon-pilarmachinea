...
class TestDice(unittest.TestCase):    
    ...
    def test_roll_dobles(self, mock_randint):
        """Prueba que roll() devuelva 4 dados iguales cuando salen dobles."""
        # Forzar que random.randint devuelva 4 en ambas llamadas
        mock_randint.side_effect = [4, 4]
        
        d = Dice()
        tirada = d.roll()
        
        self.assertEqual(len(tirada), 4)
        self.assertEqual(tirada, [4, 4, 4, 4])
